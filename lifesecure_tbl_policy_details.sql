...
CREATE TABLE `tbl_policy_details` (
  ...
  `policy_sdate` date DEFAULT NULL,
  `policy_edate` date DEFAULT NULL,
  `policy_pamount` int DEFAULT NULL,
...
INSERT INTO `tbl_policy_details` VALUES (1,1,'health','2020-02-02','2022-02-02',4000);
